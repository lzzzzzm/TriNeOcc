...
from projects.TPVFormer.tpvformer.cross_view_hybrid_attention import TPVCrossViewHybridAttention
from projects.TPVFormer.tpvformer.image_cross_attention import TPVMSDeformableAttention3D
...
class TPVFormerOccEncoder(TransformerLayerSequence):
    ...
    def point_sampling(self, reference_points, pc_range, batch_data_smaples):
        ...
        for data_sample in batch_data_smaples:
            ...
            ego2lidar.append(data_sample.ego2lidar)
