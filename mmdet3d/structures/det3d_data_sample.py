...
class Det3DDataSample(DetDataSample):
    ...
    # add gt maps
    @property
    def gt_maps(self) -> InstanceData:
        return self._gt_maps

    @gt_maps.setter
    def gt_maps(self, value: InstanceData) -> None:
        self.set_field(value, '_gt_maps', dtype=InstanceData)

    @gt_maps.deleter
    def gt_maps(self) -> None:
        del self._gt_maps
